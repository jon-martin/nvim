if jit.os == "Linux" then
    -- Linux keybinds
    vim.keymap.set({'n', 't'}, '<m-f>', '<cmd>tabnew<cr>', { desc = 'create new tab' })
    vim.keymap.set({'n', 't'}, '<m-y>', '<cmd>vsplit<cr><cmd>wincmd l<cr>', { desc = 'vertical split' })
    vim.keymap.set({'n', 't'}, '<m-l>', '<cmd>split<cr><cmd>wincmd j<cr>', { desc = 'horizontal split' })
    vim.keymap.set({'n', 't'}, '<m-n>', '<cmd>wincmd h<cr>', { desc = 'move Left' })
    vim.keymap.set({'n', 't'}, '<m-u>', '<cmd>wincmd k<cr>', { desc = 'move Up' })
    ...
    vim.keymap.set({'n', 't'}, '<c-b><up>', '<cmd>wincmd k<cr>', { desc = 'move Up' })
...
wk.add({
    ...
    { '<leader>lN',         '<cmd>cprev<CR>',                                                                                                           desc = 'previous quickfix item' },
    ...
    { '<leader>lw',         '<cmd>tcd %:p:h<CR>',                                                                                                       desc = 'set buffer as local directory' },
    { '<leader>lW',         '<cmd>tcd %:p:h:h<CR>',                                                                                                     desc = 'set buffer/.. as local directory' },
    ...
    -- Git
    { '<leader>h',          group = "git fugitive/signs" },
    { '<leader>ha',         '<cmd>!git add %<cr>',                                                                                                              desc = 'Add' },
    { '<leader>hB',         '<cmd>Gitsigns blame<cr>',                                                                                                          desc = 'Blame' },
    { '<leader>hC',         '<cmd>Gvdiffsplit!<cr>',                                                                                                            desc = 'resolve Conflict' },
    { '<leader>he',         '<cmd>diffget //2<cr>',                                                                                                             desc = 'get lEft' },
    { '<leader>hi',         '<cmd>diffget //3<cr>',                                                                                                             desc = 'get rIght' },
    { '<leader>hp',         '<cmd>Git pull<cr>',                                                                                                                desc = 'pull' },
    { '<leader>hP',         '<cmd>Git push<cr>',                                                                                                                desc = 'Push' },
    { '<leader>hs',         '<cmd>Git stash<cr>',                                                                                                               desc = 'Stash' },
    { '<leader>hS',         '<cmd>Git stash pop<cr>',                                                                                                           desc = 'Stash pop' },
    { '<leader>hb',         require('gitsigns').blame_line,                                                                                                     desc = 'blame' },
    { '<leader>hN',                                                                                                                                             desc = 'go to Previous Hunk' },
    { '<leader>hn',                                                                                                                                             desc = 'go to Next Hunk' },
    { '<leader>hr',         require('gitsigns').reset_hunk,                                                                                                     desc = 'reset Hunk' },
    { '<leader>hv',         require('gitsigns').preview_hunk,                                                                                                   desc = 'preView Hunk' },
...
vim.keymap.set({ 'n' }, '<leader>hc', '<cr>:Git commit -am ""<left>', { desc = 'Commit' })

...
wk.add({
    ...
    { '<leader>sp', '<cmd>FzfLua lsp_document_symbols<cr>',   desc = 'lsP symbols' },
    ...
    { '<leader>gq', require('gitsigns').setqflist,       desc = 'set Quicfix-list' },
    { '<leader>gd', require('gitsigns').diffthis,        desc = 'Diffthis' },
    { '<leader>gw', require('gitsigns').toggle_word_diff,desc = 'toggle Word diff' },
    -- Macros

...
wk.add({
    ...
    { '<leader>st',                                      group = "giT" },
    { '<leader>sts', '<cmd>FzfLua git_status<cr>',       desc = "git Status" },
    { '<leader>sth', '<cmd>FzfLua git_stash<cr>',        desc = "git stasH" },
    { '<leader>stc', '<cmd>FzfLua git_commits<cr>',      desc = "git Commits" },
    { '<leader>stb', '<cmd>FzfLua git_bcommits<cr>',     desc = "git Buffer commits" },
    { '<leader>str', '<cmd>FzfLua git_branches<cr>',     desc = "git bRanches" },
    -- Formatting
    ...
    -- Location list
    { '<leader>o',                                       group = "lOcation-list" },
    { '<leader>oo', '<cmd>lopen<CR>',                    desc = 'Open location list' },
    { '<leader>oq', '<cmd>lclose<CR>',                   desc = 'Quit location list' },
    { '<leader>ov', '<cmd>vsplit<cr><cmd>lnext<cr>',     desc = 'open next location-item in Vertical split' },
    { '<leader>oh', '<cmd>split<cr><cmd>lnext<cr>',      desc = 'open next location-item in Horizontal split' },
    -- Quickfix list

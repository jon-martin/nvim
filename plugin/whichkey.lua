...
vim.keymap.set('n', 'lt', ':cnext<CR>', { desc = 'nexT quickfix item' })
vim.keymap.set('n', 'lp', ':cprev<CR>', { desc = 'Previous quickfix item' })
vim.keymap.set('n', 'll', ':clast<CR>', { desc = 'go to Last quickfix item' })
vim.keymap.set('n', 'lf', ':cfirst<CR>', { desc = 'go to First quickfix item' })
